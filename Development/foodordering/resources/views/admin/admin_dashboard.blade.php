...
<div id="page-wrapper">
	<div class="main-page">
		<div class="col_3">
			<div class="col-md-3 widget widget1">
				<div class="r3_counter_box">
					...
					<div class="stats">
						...
						<h5><strong>{{$totaluserdata}}</strong></h5>
						<span>Total Users Register</span>
			...
			<div class="col-md-3 widget widget1">
				<div class="r3_counter_box">
					...
					<div class="stats">
						<h5><strong>{{$totalcategory}}</strong></h5>
						<span>Total totalcategory</span>
					</div>
				</div>
			</div>
			<div class="col-md-3 widget widget1">
			...
			<div class="col-md-3 widget widget1">
				<div class="r3_counter_box">
					...
					<div class="stats">
						<h5><strong>{{$totalemployee}}</strong></h5>
		...
		<script src="{{url('admin/js/serial.js')}}"></script>
		<script src="{{url('admin/js/export.min.js')}}"></script>
		<link rel="stylesheet" href="{{url('admin/css/export.css')}}" type="text/css" media="all" />
		<script src="{{url('admin/js/light.js')}}"></script>
		<!-- for amcharts js -->
			...
			<div class="mid-content-top charts-grids">
				<div class="middle-content">
					...
					<div id="owl-demo" class="owl-carousel text-center">
						<div class="item">
							<img class="lazyOwl img-responsive" data-src="{{url('admin/images/slider1.jpg')}}"
								alt="name">
						</div>
						<div class="item">
							<img class="lazyOwl img-responsive" data-src="{{url('admin/images/slider2.jpg')}}"
								alt="name">
						</div>
						<div class="item">
							<img class="lazyOwl img-responsive" data-src="{{url('admin/images/slider3.jpg')}}"
								alt="name">
						</div>
						<div class="item">
							<img class="lazyOwl img-responsive" data-src="{{url('admin/images/slider4.jpg')}}"
								alt="name">
						</div>
						<div class="item">
							<img class="lazyOwl img-responsive" data-src="{{url('admin/images/slider5.jpg')}}"
								alt="name">
						</div>
						<div class="item">
							<img class="lazyOwl img-responsive" data-src="{{url('admin/images/slider6.jpg')}}"
								alt="name">
						</div>
						<div class="item">
							<img class="lazyOwl img-responsive" data-src="{{url('admin/images/slider7.jpg')}}"
								alt="name">
						</div>
				...
				<div class="activity_box">
					...
					<div class="scrollbar" id="style-1">
						<div class="activity-row">
							<div class="col-xs-3 activity-img"><img src="{{url('admin/images/1.jpg')}}"
						...
						<div class="activity-row">
							<div class="col-xs-3 activity-img"><img src="{{url('admin/images/4.jpg')}}"
									class="img-responsive" alt="" /></div>
							<div class="col-xs-7 activity-desc">
						...
						<div class="activity-row">
							<div class="col-xs-3 activity-img"><img src="{{url('admin/images/3.jpg')}}"
									class="img-responsive" alt="" /></div>
							<div class="col-xs-7 activity-desc">
						...
						<div class="activity-row">
							<div class="col-xs-3 activity-img"><img src="{{url('admin/images/2.jpg')}}"
									class="img-responsive" alt="" /></div>
							<div class="col-xs-7 activity-desc">
				...
				<div class="activity_box activity_box1">
					...
					<div class="scrollbar" id="style-3">
						<div class="activity-row activity-row1">
							<div class="col-xs-3 activity-img"><img src="{{url('admin/images/1.jpg')}}"
									class="img-responsive" alt="" /><span>06:01 AM</span></div>
						...
						<div class="activity-row activity-row1">
							...
							<div class="col-xs-3 activity-img"><img src="{{url('admin/images/3.jpg')}}"
									class="img-responsive" alt="" /><span>06:02 AM</span></div>
							<div class="clearfix"> </div>
						</div>
						<div class="activity-row activity-row1">
							<div class="col-xs-3 activity-img"><img src="{{url('admin/images/1.jpg')}}"
									class="img-responsive" alt="" /><span>06:05 AM</span></div>
							<div class="col-xs-5 activity-img1">
								<div class="activity-desc-sub">
									<h5>Michael Chris</h5>
						...
						<div class="activity-row activity-row1">
							...
							<div class="col-xs-3 activity-img"><img src="{{url('admin/images/3.jpg')}}"
									class="img-responsive" alt="" /><span>06:20 PM</span></div>
							<div class="clearfix"> </div>
						</div>
					</div>
					<form action="#" method="post">
							...
							<div class="single-bottom">
								<ul>
									...
									<li>
										...
										<label for="brand5"><span></span> Orci varius natoque penatibus et magnis
											dis.</label>
									</li>
									<li>
