...
class control extends model
{
    function __construct()
    {
        ...
        switch($path)
        {
            ...
            //    $where=array("catgory_id"=>$category_id);
             ...
             case'/booking':
                ...
                {    
                    ...
                    if($res)
                    {
                        ...
                        $arr=array("book_id"=>$this->conn->insert_id);


                        $res=$this->select_where('booking1',$arr);
                        $fetch=$res->fetch_object(); // func call  and cond check 

                        $_SESSION['book_id']=$fetch->book_id;
                        ...
                        echo"
                        <script>
                        alert('thnks for booking your ca');
                         window.location='index';
                         </script>";
                    }
