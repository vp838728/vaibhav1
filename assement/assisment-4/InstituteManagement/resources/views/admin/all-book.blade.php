										...
										<div class="table">
											<table id="example3" class="display" style="min-width: 845px">
												...
												<tbody>
													@foreach($data as $d)
													<tr>
														<td><img class="rounded-circle" width="120px" src="{{url('admin/upload/book/'.$d->file)}}" width="100px" height="100px" alt=""></td>
														<td>{{$d->title}}</td>
														<td>{{$d->subject}}</td>
														<td>{{$d->AutherName}}</td>
														<td>{{$d->Publisher}}</td>
														<td><a href="javascript:void(0);"><strong>{{$d->Department}}</strong></a></td>
														<td><a href="javascript:void(0);"><strong>{{$d->Assettype}}</strong></a></td>
														<td>{{$d->Price}}</td>
														<td>
															<a href="{{url('/edit-book/'.$d->id)}}"  class="btn btn-sm btn-primary"><i class="la la-pencil"></i></a>
															<a href="{{url('/all-book/'.$d->id)}}" onclick="return confirm('are your sure want delete the recored?');"class="btn btn-sm btn-danger"><i class="la la-trash-o"></i></a>
														</td>												
													</tr>
													@endforeach
