										...
										<div class="table">
											<table id="example3" class="display" style="min-width: 845px">
												...
												<tbody>
													@foreach($data as $d)
													<tr>
														<td><img class="rounded-circle" width="120px" src="{{url('admin/upload/student/'.$d->file)}}" width="100px" height="100px" alt=""></td>
														<td>{{$d->fname}}</td>
														<td>{{$d->lname}}</td>
														<td>{{$d->gen}}</td>
														<td><a href="javascript:void(0);"><strong>{{$d->mobile}}</strong></a></td>
														<td><a href="javascript:void(0);"><strong>{{$d->rollnum}}</strong></a></td>
														<td><a href="javascript:void(0);"><strong>{{$d->class}}</strong></a></td>
														<td><a href="javascript:void(0);"><strong>{{$d->email}}</strong></a></td>
														<td><a href="javascript:void(0);"><strong>{{$d->pname}}</strong></a></td>
														<td><a href="javascript:void(0);"><strong>{{$d->address}}</strong></a></td>
														<td>
															<a href="{{url('/edit-student/'.$d->id)}}"  class="btn btn-sm btn-primary"><i class="la la-pencil"></i></a>
															<a href="{{url('/all-students/'.$d->id)}}" onclick="return confirm('are your sure want delete the recored?');"class="btn btn-sm btn-danger"><i class="la la-trash-o"></i></a>
														</td>												
													</tr>
													@endforeach
