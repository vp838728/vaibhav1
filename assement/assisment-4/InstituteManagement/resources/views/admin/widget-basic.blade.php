                ...
                <div class="row">
						...
						<div class="card">
                            <div class="card-body">
                                <div class="text-center">
                                    ...
                                    <h3 class="mt-4 mb-1">Deangelo Sena
					...
					<div class="col-xl-4 col-lg-4 col-xxl-4 col-md-6">
                        <div class="card">
                            ...
                            <div class="card-body"> 
                                <div id="DZ_W_Todo" class="widget-todo dz-scroll" style="height:370px;">
                                    <ul class="timeline">
                                        <li>
                                            <div class="timeline-badge primary"></div>
					...
					<div class="col-xl-4 col-lg-4 col-md-6">
						<div class="card">
							<div class="text-center p-3 overlay-box" style="background-image: url(images/big/img1.jpg);">
								...
								<h3 class="mt-3 mb-1 text-white">Deangelo Sena
					...
					<div class="col-xl-4 col-lg-4 col-xxl-4 col-md-12">
						<div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Visits List</h4>
                            </div>
                            <div class="card-body">
						...
						<div class="card">
                            ...
                            <div class="py-2">
                                <ul class="list-group list-group-flush dz-scroll" id="DZ_W_Doctor_List" style="height:350px;">
									...
									<li class="list-group-item">
										<a class="timeline-panel text-muted d-flex align-items-center" href="#">
											<img class="rounded-sm" alt="image" width="50" src="images/avatar/5.jpg">
											<div class="col">
                            ...
                            <div class="card-body">
                                <div class="widget-timeline">
                                    <ul class="timeline">
                                        <li>
                                            <div class="timeline-badge primary"></div>
                                           	<a class="timeline-panel text-muted d-flex" href="#">
												<div class="col pl-0">
					...
					<div class="col-xl-3 col-xxl-3 col-lg-3 col-md-6">
						<div class="card">
					...
					<div class="col-xl-4 col-lg-4 col-xxl-4 col-md-6">
						<div class="card bg-primary">
							<div class="card-body p-5 text-center text-white">
								...
								<h3 class="mt-4 text-white">Laboratory</h3>
					...
					<div class="col-xl-4 col-lg-4 col-xxl-4 col-md-6">
						<div class="card bg-success">
							<div class="card-body p-5 text-center text-white">
								<span class="display-4"><i class="icon-diamond"></i></span>
								<h3 class="mt-4 text-white">Heart Surgery</h3>
								<p class="mb-0">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry</p>
							</div>
						</div>
					</div>
					<div class="col-xl-4 col-lg-4 col-xxl-4 col-md-6">
						<div class="card bg-danger">
							<div class="card-body p-5 text-center text-white">
								...
								<h3 class="mt-4 text-white">Dentist issues</h3>
								<p class="mb-0">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry</p>
							</div>
						</div>
					</div>
						...
						<div class="row">
							...
							<div class="col-xl-6 col-lg-6 col-xxl-6 col-md-6">
								<div class="card">
									...
									<div class="card-body text-center">
										<div class="ico-sparkline">
											<div id="sparkline9" height="80"></div>
										</div>
									</div>
								</div>
							</div>
                            ...
                            <div class="card-body pb-0">
                                ...
                                <ul class="mt-5">
                                    <li class="border-bottom py-3">
                                        <div class="media">
                                            <div class="image-wrapper">
                                                <img class="rounded-circle" width="50" src="images/avatar/1.jpg" alt="product">
                                            </div>
                                    ...
                                    <li class="border-bottom py-3">
                                        <div class="media">
                                            <div class="image-wrapper">
                                                <img class="rounded-circle" width="50" src="images/avatar/2.jpg" alt="product">
                                            </div>
                                            <div class="media-body d-flex justify-content-between align-items-center ml-3">
                                                <div>
                                                    <h6>Hamburger</h6>
                                    ...
                                    <li class="py-3">
                                        <div class="media">
                                            <div class="image-wrapper">
                                                <img class="rounded-circle" width="50" src="images/avatar/3.jpg" alt="product">
                                            </div>
                                            <div class="media-body d-flex justify-content-between align-items-center ml-3">
                                                <div>
